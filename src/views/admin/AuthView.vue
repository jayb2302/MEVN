      ...
      <div class="register-block">
        ...
        <dialog ref="registerDialog">
          <form class="flex flex-wrap">
            ...
            <input type="password" class="m-2 p-2 border-b border-gray-500 bg-transparent text-gray-300 focus:outline-none flex-grow w-full" placeholder="Password" v-model="password" /> <!-- v-model for password -->
